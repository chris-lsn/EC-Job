<template>
    <md-table-row>
      ...
      <md-table-cell class="project-winbid-bidder text-center" :style="{'background-color': internalStatus.color}">{{project.employer.firstName + " " +  project.employer.lastName}}</md-table-cell>
